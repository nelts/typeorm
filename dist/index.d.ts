...
export { TypeOrm, };
export declare function AutoBindWorkerORM<T extends LocalWorkerPlugin<U>, U extends WorkerServiceFrameworker>(name: string, plu: T, configs: any, Tables: (Function | string | EntitySchema<any>)[]): void;
